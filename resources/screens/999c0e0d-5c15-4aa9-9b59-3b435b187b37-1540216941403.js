jQuery("#simulation")
  .on("click", ".s-999c0e0d-5c15-4aa9-9b59-3b435b187b37 .click", function(event, data) {
  ...
  .on("pageload", ".s-999c0e0d-5c15-4aa9-9b59-3b435b187b37 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-999c0e0d-5c15-4aa9-9b59-3b435b187b37")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("swipeup", ".s-999c0e0d-5c15-4aa9-9b59-3b435b187b37 .swipeup", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
