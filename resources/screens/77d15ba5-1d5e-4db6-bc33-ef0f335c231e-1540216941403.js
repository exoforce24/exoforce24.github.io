jQuery("#simulation")
  .on("click", ".s-77d15ba5-1d5e-4db6-bc33-ef0f335c231e .click", function(event, data) {
  ...
  .on("pageload", ".s-77d15ba5-1d5e-4db6-bc33-ef0f335c231e .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-77d15ba5-1d5e-4db6-bc33-ef0f335c231e")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("swipeup", ".s-77d15ba5-1d5e-4db6-bc33-ef0f335c231e .swipeup", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
