jQuery("#simulation")
  .on("click", ".s-f7f5a7fa-dcfc-44ec-ad57-feb243926acb .click", function(event, data) {
    ...
    if(jFirer.is("#s-statsHotspot")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-notifyHotspot")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-notifyHotspot_1")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/416225be-3e12-4d45-a54a-28d915daa06d",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-f7f5a7fa-dcfc-44ec-ad57-feb243926acb .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-f7f5a7fa-dcfc-44ec-ad57-feb243926acb")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("swipeup", ".s-f7f5a7fa-dcfc-44ec-ad57-feb243926acb .swipeup", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
